...
function main(index)
	...
	sample_bounds_array = [
	        ...
	        # dG's -
			40000 50000        ;   # 1 W_GntR_RNAP
	        -31000.0 -25000.0  ;   # 2 W_GntR_sigma_70
			40000 50000        ;   # 3 W_deGFP_RNAP
			-31000.0 -25000.0  ;	# 4 W_deGFP_sigma_70
			-31000.0 -25000.0  ;   # 5 W_deGFP_GntR
			# W_sigma_70_RNAP = 0.0

	        # binding parameters -
			1.3 1.8			; #6  n_GntR_sigma_70
			62.0 100.0		; #7  K_GntR_sigma_70
			1.3 1.8   		; #8  n_deGFP_sigma_70
			62.0 100.0  	; #9  K_deGFP_sigma_70
			1.5 3.2 		; #10 n_deGFP_GntR
			0.75 1.25		; #11 K_deGFP_GntR

	        # time constants -
			0.05 0.067	;	# 12	mRNA_GntR #unknown
			0.05 0.067 	;	# 13	mRNA_deGFP
			0.45 0.7	;	# 14	protein_GntR #unknown
			0.45 0.7    ;	# 15	protein_deGFP

	        # degradation mods -
			1.67 3.07	;	# 16	mRNA_GntR #unknown
			1.67 3.07	;	# 17	mRNA_deGFP
			50 60 		;	# 18	protein_GntR #unknown
			50 60		;	# 19	protein_deGFP
			0.15 0.32 	;	# 20	protein_sigma_70
